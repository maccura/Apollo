...
****************************************************************************/
#ifndef IMAGE_VARIANT_HPP
#define IMAGE_VARIANT_HPP
#include "base_homogeneous_variant.hpp"
#include <QJsonDocument>
namespace ReportDesign
{

class image_variant: public base_homogeneous_variant
{
public:
    image_variant(QString moduleJson);
    ~image_variant() {}
    // 同类过滤器
    virtual bool inField(QString Field, const QJsonValue &jsonValue) override;
};
}
#endif // IMAGE_VARIANT_HPP
