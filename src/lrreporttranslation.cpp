#include "lrreporttranslation.hpp"
...
ReportTranslation::ReportTranslation(QLocale::Language language, QList<page_scene *> pages)
    : m_language(language)
{
    foreach (page_scene *page, pages)
    {
...
PageTranslation *ReportTranslation::createPageTranslation(page_scene *page)
{
    ...
    foreach (base_design_item *item, page->pageItem()->allChildBaseItems())
    {
...
void ReportTranslation::createItemTranslation(base_design_item *item, PageTranslation *pageTranslation)
{
...
void ReportTranslation::updatePageTranslation(page_scene *page)
{
